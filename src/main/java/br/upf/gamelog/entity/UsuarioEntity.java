...
public class UsuarioEntity implements Serializable {
    ...
    /** Foto armazenada como Base64 Data URL (ex.: data:image/png;base64,...) */
    ...
    /**
     * Retorna o nome de exibição: apelido se definido, senão o nome completo.
     */
    public String getNomeExibicao() {
        return (apelido != null && !apelido.trim().isEmpty()) ? apelido.trim() : nome;
    }
